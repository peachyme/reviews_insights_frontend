...
import { useGetHighestRatedCategoriesQuery } from 'api/apiSlice';
...
const HighlyRatedCategories = () => {
  const { data: fetchedCategories, isLoading: isLoadingCategories, error: categoriesError } = useGetHighestRatedCategoriesQuery();
...
export default HighlyRatedCategories;
